# Tiltak - gul sone - Planer CarePlan Hacking v0.4.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Tiltak - gul sone**

## Example CarePlan: Tiltak - gul sone
...
**addresses**: [Condition ](Condition-ZoneCondition-Yellow-Oddfrid-V2.md)
...
| :--- | :--- | :--- |
| - | **Status** | **Description** |
| * | Not Started | Øk medikamentdose og kontakt fastlege innen 24 timer |
...
```json
{
  ...
  "activity" : [{
    "detail" : {
      "status" : "not-started",
      "description" : "Øk medikamentdose og kontakt fastlege innen 24 timer"
    }
  }]
}
