...
Dette er en alternativ modell til [v1](planer-CarePlan-v1.html). I stedet for å beskrive det anbefalte tiltaket i `Condition.note`, samles hver sone i en egen `CarePlan` der tiltaket beskrives i `CarePlan.activity.detail.description`.
...
{% include careplan-zones-model-v2.svg %}

### Eksempel (pasientplan med soner, v2)

Et komplett eksempel er definert i FSH-instansene:

- [`CarePlan-Oddfrid-Zones-V2`](CarePlan-CarePlan-Oddfrid-Zones-V2.html) (overordnet plan)
- [`CarePlan-Oddfrid-Green-V2`](CarePlan-CarePlan-Oddfrid-Green-V2.html)
- [`CarePlan-Oddfrid-Yellow-V2`](CarePlan-CarePlan-Oddfrid-Yellow-V2.html)
- [`CarePlan-Oddfrid-Red-V2`](CarePlan-CarePlan-Oddfrid-Red-V2.html)
- [`ZoneCondition-Green-Oddfrid-V2`](Condition-ZoneCondition-Green-Oddfrid-V2.html)
- [`ZoneCondition-Yellow-Oddfrid-V2`](Condition-ZoneCondition-Yellow-Oddfrid-V2.html)
- [`ZoneCondition-Red-Oddfrid-V2`](Condition-ZoneCondition-Red-Oddfrid-V2.html)

Objektdiagrammet under viser hvordan eksempelinstansene henger sammen for Oddfrid:

{% include careplan-zones-example-v2.svg %}
