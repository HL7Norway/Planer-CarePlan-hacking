...
Se også [v2](planer-CarePlan-v2.html), en alternativ modell der tiltaket for hver sone beskrives i `CarePlan.activity` på en egen sone-CarePlan i stedet for i `Condition.note`.
...
- [`CarePlan-Oddfrid-Zones`](CarePlan-CarePlan-Oddfrid-Zones.html)
- [`ZoneCondition-Green-Oddfrid`](Condition-ZoneCondition-Green-Oddfrid.html)
- [`ZoneCondition-Yellow-Oddfrid`](Condition-ZoneCondition-Yellow-Oddfrid.html)
- [`ZoneCondition-Red-Oddfrid`](Condition-ZoneCondition-Red-Oddfrid.html)
